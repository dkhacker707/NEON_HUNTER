...
class NeonHunter:
    def __init__(self, root):
        ...
        tk.Label(controls, text="Target URL:", fg='#ff00ff', bg='#000000', font=('Consolas', 14, 'bold')).grid(row=0, column=0, sticky='e')
        ...
        self.progress.pack(fill='x', padx=80, pady=15)

        self.log_text = scrolledtext.ScrolledText(root, bg='#000011', fg='#00ff41', font=('Consolas', 10, 'bold'), 
                                                 height=25, insertbackground='#00ffff', relief='ridge', bd=3)
        self.log_text.pack(fill='both', expand=True, padx=30, pady=15)

        # Monitoring windows (created on fuzz start)
        ...
        self.log("🚀 NEONHUNTER v3.4 - DIRECT FUZZ + LIVE MONITORING READY!")
    ...
    def export_results(self):
        self.play_click_sound()
        if not self.results:
            messagebox.showinfo("No Results", "No vulnerabilities found yet!")
            return
        self.log("📊 Report exported (placeholder)")
